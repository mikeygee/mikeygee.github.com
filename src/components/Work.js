...
import { convertLinks, imagePath } from '../utils';
...
const RESUME_DATA = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        imageComponent: (
          <BlinktagLogoImage src={imagePath('blinktag.png')} alt="Blinktag logo" />
        ),
      ...
      },
      {
        ...
        company:
          '[UCLA College Information Services](http://uit.ucla.edu)',
        image: imagePath('ucla.jpg'),
        alt: 'UCLA logo',
    ...
    items: [
      ...
      },
      {
        ...
        description: [
          ...
          'Initially built with [Jekyll](https://jekyllrb.com), converted to [Gatsby](https://www.gatsbyjs.org), now plain [React](https://react.dev)',
        ],
      },
      {
    ...
    items: [
      {
        ...
        image: imagePath('ucla.png'),
        dates: '2002-2006',
        description: ['B.S. Computer Science', 'GPA: 3.28'],
      },
      {
        title: '[Saylor University](https://learn.saylor.org)',
        image: imagePath('sayloruniversity.png'),
        dates: '2023-2024',
        description: [
          '[Bitcoin For Developers](assets/docs/cs120.pdf)',
          '[Principles of Austrian Economics](assets/docs/econ103.pdf)',
        ],
      },
      {
        title: '[Coursera](https://www.coursera.org)',
        image: imagePath('coursera.jpeg'),
        dates: '2012',
        description: [
          '[Human computer interaction](assets/docs/hci.pdf)',
          '[Gamification](assets/docs/gamification.pdf)',
        ],
      },
      {
        title:
          '[Los Angeles Baptist Jr/Sr High School](https://heritage-schools.org)',
        image: imagePath('lab.jpg'),
        dates: '1997-2002',
        description: [
          'GPA: 4.0',
                ...
                <div>
                  <h3
                    dangerouslySetInnerHTML={{
                      __html: convertLinks(title),
                    }}
                  />
                  {company ? (
                    <h4
                      dangerouslySetInnerHTML={{
                        __html: convertLinks(company),
                      }}
                    />
                  ) : null}
                  {location ? (
                  ...
                  <ul>
                    {description.map((bullet, j) => (
                      <li
                        key={`${sectionTitle}Item${i}Bullet${j}`}
                        dangerouslySetInnerHTML={{
                          __html: convertLinks(
                            bullet
                          ),
